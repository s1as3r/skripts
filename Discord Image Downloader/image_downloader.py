...
if __name__ == "__main__":
    ...
    print(
        "Select The Server And Click On the Channel You Want To Download Images From and Then Press Enter here."
    )
    input(
        "You Can also try and scroll to the top of the channel to get all the images."
    )
